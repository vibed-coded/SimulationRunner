...
class PlayerTest {
    ...
    void testPlayerConstructorWithValidCoordinates() {
        Player player = new Player(new GridPosition(5, 7));
    ...
    void testPlayerConstructorWithZeroCoordinates() {
        Player player = new Player(new GridPosition(0, 0));
    ...
    void testPlayerConstructorWithNegativeXThrowsException() {
        assertThrows(IllegalArgumentException.class, () -> {
            new Player(new GridPosition(-1, 5));
        });
    }
    ...
    void testPlayerConstructorWithNegativeYThrowsException() {
        assertThrows(IllegalArgumentException.class, () -> {
            new Player(new GridPosition(5, -1));
        });
    }
    ...
    void testPlayerRecordEquality() {
        Player player1 = new Player(new GridPosition(3, 4));
        Player player2 = new Player(new GridPosition(3, 4));
        Player player3 = new Player(new GridPosition(5, 6));
    ...
    void testPlayerToString() {
        Player player = new Player(new GridPosition(7, 9));
    ...
    void testMoveBeyondLeftBoundary() {
        GridConfig config = new GridConfig(10, 10, 50);
        Player player = new Player(new GridPosition(0, 5));
    ...
    void testMoveBeyondRightBoundary() {
        GridConfig config = new GridConfig(10, 10, 50);
        Player player = new Player(new GridPosition(9, 5));
    ...
    void testMoveBeyondTopBoundary() {
        GridConfig config = new GridConfig(10, 10, 50);
        Player player = new Player(new GridPosition(5, 0));
    ...
    void testMoveBeyondBottomBoundary() {
        GridConfig config = new GridConfig(10, 10, 50);
        Player player = new Player(new GridPosition(5, 9));
